...
Provides a simple way to add rating functionality to your application for Rails 3 Applications. 

!http://s3.amazonaws.com/ember/v9SvvO3rdSkA40e1sXBf8JgpuaWCC0uB_o.png!

h2. History

Forked from github.com/edgarjs/ajaxful-rating to be Rails 3 compatible and added some new features

h2. Repository

Find it at "http://github.com/joelbasson/ajaxful-rating":https//github.com/joelbasson/ajaxful-rating
...
To install add the following to your gemfile:
  ...
  @gem 'ajaxful_rating', :git => 'git://github.com/joelbasson/ajaxful-rating.git'@
...
as the second param to display only the static stars (not clickable).
And also you can pass the dimension you want to show the ratings for. You can also pass in a value
and it will just generate non-clickable stars based on the value and the max stars for the model

<pre>
#show.html.erb
<%= ratings_for @article %>

#To display static stars with a given value:
<%= ratings_for @article, :value => 6 %> or <%= ratings_for @article, :value => review.rating %>
