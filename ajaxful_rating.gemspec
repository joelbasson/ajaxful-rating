...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG", "Manifest", "README.textile", "Rakefile", "ajaxful_rating.gemspec", "lib/generators/ajaxful_rating/USAGE", "lib/generators/ajaxful_rating/ajaxful_rating_generator.rb", "lib/generators/ajaxful_rating/templates/images/star.png", "lib/generators/ajaxful_rating/templates/images/star_small.png", "lib/generators/ajaxful_rating/templates/migration.rb", "lib/generators/ajaxful_rating/templates/model.rb", "lib/generators/ajaxful_rating/templates/style.css", "init.rb", "lib/ajaxful_rating.rb", "lib/axr/css_builder.rb", "lib/axr/errors.rb", "lib/axr/helpers.rb", "lib/axr/locale.rb", "lib/axr/model.rb", "lib/axr/stars_builder.rb"]
